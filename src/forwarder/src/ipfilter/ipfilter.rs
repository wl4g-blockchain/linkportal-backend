...
use linkportalbackend_server::{cache::redis::StringRedisCache, config::config};
...
impl IPFilterManager {
    ...
    pub async fn init() {
        tracing::info!("Register LinkPortalBackend Redis IPFilter ...");
        ...
        {
            Ok(registered) => {
                tracing::info!("Initializing LinkPortalBackend Redis IPFilter ...");
